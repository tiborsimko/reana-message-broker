...
g = {}
with open(os.path.join("..", "reana_message_broker", "version.py"), "rt") as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    "logo": "logo-reana.png",
    "description": """<p>REANA-Message-Broker is a component of the <a
                      href="http://www.reana.io">REANA</a> reusable and
                      reproducible research data analysis
                      platform.</p><p>REANA-Message-Broker provides a broker
                      service for event messages and notifications.</p>""",
