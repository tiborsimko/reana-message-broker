...
## [0.95.0](https://github.com/tiborsimko/reana-message-broker/compare/0.9.3...0.95.0) (2026-09-22)
...
* **config:** use glob for egg-info in flake8 exclude ([#77](https://github.com/tiborsimko/reana-message-broker/issues/77)) ([a97db34](https://github.com/tiborsimko/reana-message-broker/commit/a97db349f92d3e02f4819cf5f8330ff1824c67ae))
...
* **actions:** pin setuptools 70 ([#72](https://github.com/tiborsimko/reana-message-broker/issues/72)) ([06b1cc5](https://github.com/tiborsimko/reana-message-broker/commit/06b1cc50a9493b163852ae71eb7f8a4a0765f891))
...
* **jsonlint:** add JSON linting checks ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([398c18c](https://github.com/tiborsimko/reana-message-broker/commit/398c18cf347039198e2241a1462fc82459386fe1))
* **markdownlint:** add Markdown linting checks ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([c2da24a](https://github.com/tiborsimko/reana-message-broker/commit/c2da24aa5a14cb4381def26cdffb7c8cccc5b8c0))
...
* **prettier:** add Prettier code formatting checks ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([73cf687](https://github.com/tiborsimko/reana-message-broker/commit/73cf687608042b5432212c8500ead07cbfbd2070))
...
* **python:** remove obsolete pytest-pep8 dependency ([#84](https://github.com/tiborsimko/reana-message-broker/issues/84)) ([d64de29](https://github.com/tiborsimko/reana-message-broker/commit/d64de29ed1afa424d71ecb5169ac5b8381c9beb3))
...
* **release-please:** upgrade action to v5 ([#85](https://github.com/tiborsimko/reana-message-broker/issues/85)) ([255e23e](https://github.com/tiborsimko/reana-message-broker/commit/255e23ec05da3a050a4b23075e662b75ca5eec90))
...
* **run-tests:** add usage help and refactor options ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([6aa9c2e](https://github.com/tiborsimko/reana-message-broker/commit/6aa9c2e0dd3b627bb0f4af78def9e5a6b489c793))
...
* **shfmt:** add shfmt code formatting checks ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([7b714d3](https://github.com/tiborsimko/reana-message-broker/commit/7b714d3fb51832076f274e5e3df6cba2f0ec3b56))
...
* **yamllint:** add YAML linting checks ([#82](https://github.com/tiborsimko/reana-message-broker/issues/82)) ([6d135db](https://github.com/tiborsimko/reana-message-broker/commit/6d135dbbad2fd712a1a0005d53929fd4dcf25a15))
